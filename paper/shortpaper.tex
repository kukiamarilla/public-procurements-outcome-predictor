...
% Formatting follows the IEEE conference \LaTeX{} template (IEEE-conference-template-062824, Jun.\ 2024) with the matching \texttt{IEEEtran.cls}.
...
\and
\IEEEauthorblockN{Juan Ignacio Pane Fernandez}
\IEEEauthorblockA{\textit{Universidad Nacional de Asunci\'on}\\
Asunci\'on, Paraguay\\
jpane@pol.una.py}
}
...
\bibitem{salazar2024vigia}
Andr{\'e}s Salazar, Juan F. P{\'e}rez, and Jorge Gallego.
\newblock VigIA: Prioritizing Public Procurement Oversight with Machine Learning Models and Risk Indices.
\newblock \emph{Data \& Policy}, 2024.

\bibitem{acikalin2024procurementcalls}
U. U. Acikalin, A. Tsakalidis, G. {\"O}zcan, M. Fazekas, and G. Ifrim.
\newblock How You Describe Procurement Calls Matters: Predicting Outcome of Public Procurement Using Call Descriptions.
\newblock \emph{Natural Language Engineering}, 2024.
...
\bibitem{alvaprincipe2025survey}
R. A. Alva Principe, N. Chiarini, and M. Viviani.
\newblock Long Document Classification in the Transformer Era: A Survey on Challenges, Advances and Open Issues.
\newblock \emph{WIREs Data Mining and Knowledge Discovery}, 15(2):e70019, 2025.

\bibitem{agarwal2025gptoss}
S. Agarwal et al.
\newblock gpt-oss-120b \& gpt-oss-20b Model Card.
\newblock \emph{arXiv preprint arXiv:2508.10925}, 2025.

\bibitem{wang2024improvingembeddings}
...
\newblock Classifier Calibration: A Survey on How to Assess and Improve Predicted Class Probabilities.
\newblock \emph{Machine Learning}, 112:3211--3260, 2023.

\bibitem{richardson2024roc}
Eve Richardson, Raphael Trevizani, Jason A. Greenbaum, Hannah Carter, Morten Nielsen, and Bjoern Peters.
\newblock The Receiver Operating Characteristic Curve Accurately Assesses Imbalanced Datasets.
\newblock \emph{Patterns}, 2024.

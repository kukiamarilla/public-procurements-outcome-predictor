...
\author{\IEEEauthorblockN{Isaac Gabriel Amarilla Benitez, Luis Fernando Caballero Ramoa,\\
Julio Manuel Paciello Coronel, and Juan Ignacio Pane Fernandez}
\IEEEauthorblockA{\footnotesize Universidad Nacional de Asunci\'on\\
sc.amarilla@fpuna.edu.py, luisfercaballero27@fpuna.edu.py,\\
julio.paciello@pol.una.py, jpane@pol.una.py}}

...
\input{Capitulos/shortpaper_fragments/resultados}
...
\input{Capitulos/shortpaper_fragments/discusion}
...
Acikalin et al. encontraron señal predictiva en descripciones de convocatorias \cite{acikalin2024procurementcalls}; este estudio encuentra señal en PBC paraguayos completos. La coincidencia apoya la idea general de que el lenguaje disponible durante la convocatoria permite anticipar desenlaces, pero no permite equiparar variables objetivo ni magnitudes.

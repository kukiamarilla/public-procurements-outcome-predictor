...
Los sistemas de apoyo a la supervisión requieren esta distinción. El proyecto VigIA, desarrollado para la Veeduría Distrital de Bogotá, combina modelos predictivos e índices de riesgo con el propósito de asignar mejor los recursos de control; sus autores presentan la herramienta como apoyo a los organismos de supervisión para priorizar investigaciones, no como sustituto de la revisión institucional \cite{salazar2024vigia}. La literatura sobre advertencias tempranas formula una idea similar: el valor operativo de la predicción reside en anticipar dónde conviene revisar, siempre que se documenten el objetivo, las limitaciones y los errores posibles \cite{gallego2021earlywarning}. En el contexto paraguayo, esta investigación adopta ese enfoque prudente.

\input{Capitulos/shortpaper_fragments/introduccion}
...
\begin{enumerate}
  \item ¿Cuánta señal predictiva sobre el resultado de una contratación contiene el PBC publicado al inicio del proceso?
  \item ¿Cómo se comparan los embeddings densos producidos por un LLM congelado y la representación léxica TF--IDF al extraer esa señal?
...
\begin{enumerate}
  ...
  \item Cuantificar la señal predictiva contenida en los PBC mediante una evaluación externa al entrenamiento y su comparación con referencias triviales.
  \item Comparar el desempeño de embeddings densos producidos por un LLM congelado con el de una representación léxica TF--IDF.
  \item Determinar si el modelado explícito de relaciones entre fragmentos aporta ventajas frente a la agregación por promedio de los mismos embeddings.
  \item Caracterizar las diferencias entre modelos en términos de ordenamiento, desempeño a umbral fijo, calibración y sensibilidad al umbral.
...
El Capítulo~\ref{sec:marco_teorico} presentará el marco institucional y conceptual de la contratación pública y de los sistemas digitales que respaldan su registro y publicación, así como los fundamentos de representación textual, transformers, clasificación, calibración y evaluación. El Capítulo~\ref{sec:trabajos_relacionados} recorrerá cronológicamente la evolución de la analítica de contratación y del procesamiento de documentos extensos, y concluirá con la oportunidad y el aporte de la propuesta. El Capítulo~\ref{sec:propuesta_experimental} describirá la construcción del conjunto de datos, la canalización, los modelos y el protocolo que se empleará. El Capítulo~\ref{sec:resultados} expondrá las pruebas y analizará sus resultados. Finalmente, el Capítulo~\ref{sec:conclusiones} sintetizará las conclusiones y propondrá trabajos futuros.

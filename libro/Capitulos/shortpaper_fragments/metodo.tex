\ifdefined\metodoComoSubsecciones
  \let\seccionMetodo\subsection
\else
  \let\seccionMetodo\section
\fi

\seccionMetodo{Representación documental}
...
\seccionMetodo{Arquitectura del predictor}
